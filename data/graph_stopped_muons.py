...
class graph_w_edge2(Dataset):
    ...
    def path(self):
        ...
        path = osp.join(cwd, "processed/graph_stopped_muons")
        return path
...
if __name__ == "__main__":
    ...
    if os.path.isdir(osp.join(path, "processed", "graph_stopped_muons")):
        shutil.rmtree(osp.join(path, "processed", "graph_stopped_muons"))
    if len(sys.argv) == 2:

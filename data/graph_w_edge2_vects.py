...
class graph_w_edge2(Dataset):
    ...
    def path(self):
        ...
        path = osp.join(cwd, "processed/graph_w_edge2_vects")
        return path
    ...
    def download(self):
        ...
        with sqlite3.connect(db_file) as conn:
            ...
            for col in ["direction_x", "direction_y", "direction_z"]:
...
if __name__ == "__main__":
    ...
    if os.path.isdir(osp.join(path, "processed", "graph_w_edge2_vects")):
        shutil.rmtree(osp.join(path, "processed", "graph_w_edge2_vects"))
    if len(sys.argv) == 2:
